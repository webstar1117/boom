    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="create_form" method="post" action="{{url('/admin/blog-category/create')}}">
                    {{ csrf_field() }}
                    <div class="row mb-2">
                        <div class="col-4">
...
<div class="modal fade bs-example-modal-lg" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit_form" method="post" action="{{url('/admin/blog-category/edit')}}">
                    {{ csrf_field() }}
...
<div class="modal fade bs-example-modal-lg" id="del_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit_form" method="post" action="/admin/blog/delete">
                    {{ csrf_field() }}
...
<script>
    ...
    function ReadyEdit(blog, idx) {
        var blog = JSON.parse(blog);
        $('#id_edit').val(blog.id);
        $('#category_edit').val(blog.name);
