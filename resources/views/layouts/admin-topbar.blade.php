    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ url('/admin/list-user') }}" class="logo logo-dark">
                    <span class="logo-sm">
                ...
                <a href="{{ url('/admin/list-user') }}" class="logo logo-light">
                    <span class="logo-sm">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <!-- <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg') }}"
                        alt="Header Avatar"> -->
                    <span
                        class="d-none d-xl-inline-block ml-1">{{ Auth::check() && Auth::user()->firstname ? Auth::user()->firstname : null }}</span>
